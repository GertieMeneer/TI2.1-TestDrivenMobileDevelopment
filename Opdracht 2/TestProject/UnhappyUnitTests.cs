...
namespace TestProject
{
    public class UnhappyUnitTests
    {
        ...
        public async Task TestToggleLamp()
        {
            ...
            await Lamps[0].ToggleLamp();

            Assert.True(Lamps[0].Status);
        }
        ...
        public async Task TestSetBrightness()
        {
            ...
            await Lamps[0].SetBrightness(10);

            Assert.True(Lamps[0].Brightness == 254);
        }
        ...
        public async Task TestSetColor()
        {
            ...
            await Lamps[0].SetColor(400, 34);

            Assert.True(Lamps[0].Hue == 4444 && Lamps[0].Sat == 254);
        }
    }
}
